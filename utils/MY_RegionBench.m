function ICG_RegionBench(imgDir, gtDir, inDir, outDir, nthresh)
...
parfor i = 1 : numel(iids),
    ...
    imFile = fullfile(imgDir, strcat(iids(i).name(1:end-4), '.jpg'));
    ...
    evaluation_reg_image_my(imFile, inFile, gtFile, evFile2, evFile3, evFile4, nthresh);
    disp(i);
end
