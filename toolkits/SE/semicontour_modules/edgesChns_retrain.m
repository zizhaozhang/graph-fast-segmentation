function [chnsReg,chnsSim] = edgesChns_retrain( I, opts )
...
for t=1:nTypes
  ...
  if(size(I,3)==1), cs='gray'; else cs='rgb'; end; I=rgbConvert(I,cs);
...
%     [M,~] = gradientMag( I1, 0, opts.normRad, .01 );
    [M,O] = edgesDetect(I1,opts.ltmodel.model);
